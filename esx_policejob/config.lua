...
---------------------------------- QUASAR INVENTORY CONFIG -----------------------------------------------------------                                                                                                                                               
																																						   
																																						   
Config.QSInventory = true -- Put on false if you don't use qs-inventory

Config.StashName = 'Police Stash' -- the name of the stash you want
Config.Slots = 50  -- Number of slots in the job stash [ONLY FOR QUASAR INVENTORY] 
Config.Weight = 5000 -- weight of the job stash [ONLY FOR QUASAR INVENTORY] 


---------------------------------- QUASAR SMARTPHONE CONFIG -----------------------------------------------------------  



Config.QSSmartphone = true -- Put on false if you don't use qs-smartphone (only to lock it when cuffed)
